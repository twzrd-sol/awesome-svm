...
| TWZRD Agent Intel | Solana-native x402 MCP server for AI agent trust scoring — free on-chain preflight checks + paid signed V5 trust receipts | Active | [Website](https://intel.twzrd.xyz), [GitHub](https://intel.twzrd.xyz) |
